				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Laporan Harian</h2>
								<ul class=" text-white breadcrumbs">
									...
									<li class="text-white nav-item">
										<a class="text-white" href="laporan_harian.php">Laporan Harian</a>
									</li>
								</ul>
							</div>
								...
								<div class="card-body">
									<div class="card-title"></div>
										...
										<form action="" method="post">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group form-group-default">
														...
														<input name="tfTglAwal" type="date" class="form-control" value="">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group form-group-default">
														<label>Tanggal Akhir</label>
														<input name="tfTglAkhir" type="date" class="form-control" value="">
													</div>
												</div>
												<div class="col-md-2">
											...
											<form method="post" action="cetak_harian.php" target="_blank">
											<div class="row">
												<div class="col-md-12">
