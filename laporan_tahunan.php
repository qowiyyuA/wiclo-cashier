							...
							<div>
								...
								<ul class=" text-white breadcrumbs">
									...
									<li class="text-white nav-item">
										<a class="text-white" href="laporan_tahunan.php">Laporan Tahunan</a>
									</li>
								</ul>
							</div>
								...
								<div class="card-body">
									<div class="card-title"></div>
										...
										<form action="" method="post">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group form-group-default">
														...
														<input name="tfTglAwal" type="text" class="form-control" value="">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group form-group-default">
														<label>Tahun Akhir</label>
														<input name="tfTglAkhir" type="text" class="form-control" value="">
													</div>
												</div>
												<div class="col-md-2">
											...
											<form method="post" action="cetak_tahunan.php" target="_blank">
											<div class="row">
												<div class="col-md-12">
